...
public class ReservationService {
  ...
  public ReservationResponseDTO createReservation(ReservationRequestDTO request) {
    ...
    RoomEntity room =
        roomRepository
            ...
            .orElseThrow(
                () ->
                    new EntityNotFoundException("Room not found with ID: " + request.getRoomId()));
    ...
    boolean hasOverlap =
        !reservationRepository
            .findByRoomIdAndEndDateAfterAndStartDateBefore(
  ...
  public List<Interval> getFreeIntervals(Long roomId, LocalDate searchStart, LocalDate searchEnd) {
    ...
    for (ReservationEntity reservation : reservations) {
      ...
      availableFrom =
          reservation.getEndDate().isAfter(availableFrom)
